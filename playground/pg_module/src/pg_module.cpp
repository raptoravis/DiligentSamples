...
{
    return new pg_module();
}

void pg_module::CreatePipelineState()
{
...
void pg_module::CreateVertexBuffer()
{
...
void pg_module::CreateIndexBuffer()
{
    Uint32 Indices[] =
    {
        2,0,1,    2,3,0,
...
void pg_module::Initialize(IEngineFactory*  pEngineFactory,
...
void pg_module::Update(double CurrTime, double ElapsedTime)
{
